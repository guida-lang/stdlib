...
{-| Create an absolute URL:
    ...
    absolute [ "packages", "guida-lang", "stdlib" ] []
    -- "/packages/guida-lang/stdlib"
...
{-| Create custom URLs that may have a hash on the end:
    ...
    custom Absolute
      [ "packages", "guida-lang", "stdlib", "latest", "String" ]
      []
      (Just "length")
    -- "/packages/guida-lang/stdlib/latest/String#length"
