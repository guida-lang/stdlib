...
import Guida.Kernel.List
import Guida.Kernel.String
...
This is not true in Guida. You must use double quotes for a `String`, and you must
...
split sep string =
    Guida.Kernel.List.fromArray (Guida.Kernel.String.split sep string)
...
join sep chunks =
    Guida.Kernel.String.join sep (Guida.Kernel.List.toArray chunks)
...
startsWith =
    Guida.Kernel.String.startsWith
...
fromInt : Int -> String
fromInt =
    Guida.Kernel.String.fromNumber
