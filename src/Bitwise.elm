...
complement : Int -> Int
complement =
    Guida.Kernel.Bitwise.complement
...
shiftLeftBy =
    Guida.Kernel.Bitwise.shiftLeftBy
...
shiftRightBy =
    Guida.Kernel.Bitwise.shiftRightBy
...
shiftRightZfBy =
    Guida.Kernel.Bitwise.shiftRightZfBy
