effect module Random where { command = MyCmd } exposing
    ...
    , andThen, lazy
    , maxInt, minInt
    , Seed, step, initialSeed, independentSeed
    )
...
This generator _can_ produce values outside of the range [[`minInt`](#minInt),
...
[here](https://guida-lang.org/docs/1.0.0/hints/bad-recursion)!
...
{- Explanation of the PCG algorithm
   ...
   multithreading, and guida-test relies on this feature.
...
random numbers. Commands are one of the core concepts in Guida, and it will
...
about it in [the Guida discord][discord]. Folks are happy to help!
...
[discord]: https://discord.gg/B6WgPzf5Aa
...
normal Guida function. Same input, same output! So to get a 3D point you could
say:
...
In practice, you may want to get the initial seed by (1) sending it to Guida
