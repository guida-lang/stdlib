...
import Json.Decode
import Test.Html.Internal.GuidaHtml.InternalTypes as InternalTypes
...
[`text`](http://package.guida-lang.org/packages/guida-lang/stdlib/latest/Html-Attributes#text)
...
{-| Matches elements that have a
[`selected`](http://package.guida-lang.org/packages/guida-lang/stdlib/latest/Html-Attributes#selected)
...
{-| Matches elements that have a
[`disabled`](http://package.guida-lang.org/packages/guida-lang/stdlib/latest/Html-Attributes#disabled)
attribute with the given value.
-}
...
{-| Matches elements that have a
[`checked`](http://package.guida-lang.org/packages/guida-lang/stdlib/latest/Html-Attributes#checked)
attribute with the given value.
-}
