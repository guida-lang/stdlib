...
In Guida, you do this by calling
[special functions](https://package.guida-lang.org/packages/guida-lang/stdlib/latest/Html-Events#stopPropagationOn)
in `Html.Events`.
...
findEvent : String -> GuidaHtml msg -> Result String (Decoder (Handling msg))
