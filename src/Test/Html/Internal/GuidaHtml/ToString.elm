module Test.Html.Internal.GuidaHtml.ToString exposing
    ( nodeRecordToString, nodeToString, nodeToStringWithOptions
    , FormatOptions, defaultFormatOptions
    )

{-| Convert GuidaHtml to string.
...
nodeToLines : FormatOptions -> GuidaHtml msg -> List String
...
-}
nodeToString : GuidaHtml msg -> String
nodeToString =
...
-}
nodeToStringWithOptions : FormatOptions -> GuidaHtml msg -> String
