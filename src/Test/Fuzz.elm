...
fuzzTest distribution fuzzer untrimmedDesc getExpectation =
    ...
    if String.isEmpty desc then
        ...
        GuidaTestVariant__Labeled desc <| validatedFuzzTest fuzzer getExpectation distribution
        ...
        Just
            ...
            , expectation =
                Test.Expectation.fail
                    { description = "guida-test distribution collection bug"
