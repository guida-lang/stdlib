...
your Guida code; it's easy and makes your tests reproducible.
...
distributeSeedsHelp hashed runs seed test =
    case test of
        Internal.GuidaTestVariant__UnitTest aRun ->
            { seed = seed
        ...
        Internal.GuidaTestVariant__FuzzTest aRun ->
            let
                ( firstSeed, nextSeed ) =
        ...
        Internal.GuidaTestVariant__Labeled description subTest ->
