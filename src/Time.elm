...
now : Task x Posix
now =
    Guida.Kernel.Time.now millisToPosix
...
[env]: /packages/guida-lang/stdlib/latest/Browser#Env
...
Check out [this example](https://guida-lang.org/examples/time) to see how to use
...
**Note:** If you use this, please share your work in a Guida community forum!
