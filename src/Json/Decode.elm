...
{-| Turn JSON values into Guida values. Definitely check out this [intro to
...
{-| Decode a JSON string into a Guida `String`.
...
string =
    Guida.Kernel.Json.decodeString


{-| Decode a JSON boolean into a Guida `Bool`.
...
bool : Decoder Bool
bool =
    Guida.Kernel.Json.decodeBool


{-| Decode a JSON number into a Guida `Int`.
...
int : Decoder Int
int =
    Guida.Kernel.Json.decodeInt


{-| Decode a JSON number into a Guida `Float`.
...
{-| Decode a nullable JSON value into a Guida value.
...
{-| Decode a JSON array into a Guida `List`.
...
list =
    Guida.Kernel.Json.decodeList


{-| Decode a JSON array into a Guida `Array`.
...
array =
    Guida.Kernel.Json.decodeArray


{-| Decode a JSON object into a Guida `Dict`.
...
{-| Decode a JSON object into a Guida `List` of pairs.
...
keyValuePairs =
    Guida.Kernel.Json.decodeKeyValuePairs
...
{-| Ignore the JSON and produce a certain Guida value.
...
{-| Do not do anything with a JSON value, just bring it into Guida as a `Value`.
...
value : Decoder Value
value =
    Guida.Kernel.Json.decodeValue


{-| Decode a `null` value into some Guida value.
