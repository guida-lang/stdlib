...
{-| Library for turning Guida values into Json values.
...
list func entries =
    Guida.Kernel.Json.wrap
        (List.foldl (Guida.Kernel.Json.addEntry func) (Guida.Kernel.Json.emptyArray ()) entries)
...
array func entries =
    Guida.Kernel.Json.wrap
        (Array.foldl (Guida.Kernel.Json.addEntry func) (Guida.Kernel.Json.emptyArray ()) entries)
...
set func entries =
    Guida.Kernel.Json.wrap
        (Set.foldl (Guida.Kernel.Json.addEntry func) (Guida.Kernel.Json.emptyArray ()) entries)
...
object pairs =
    Guida.Kernel.Json.wrap
        (List.foldl
            (\( k, v ) obj -> Guida.Kernel.Json.addField k v obj)
            (Guida.Kernel.Json.emptyObject ())
            pairs
        )
...
dict toKey toValue dictionary =
    Guida.Kernel.Json.wrap
        (Dict.foldl
            (\key value obj -> Guida.Kernel.Json.addField (toKey key) (toValue value) obj)
            (Guida.Kernel.Json.emptyObject ())
            dictionary
        )
