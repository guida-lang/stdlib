...
the server, you load whatever assets you want from within Guida. Maybe you do
...
replaceUrl =
    Guida.Kernel.Browser.replaceUrl
...
page load**, even if the provided URL is the same as the current one.
    ...
    gotoGuidaWebsite : Cmd msg
    gotoGuidaWebsite =
        load "https://guida-lang.org"

Check out the [`elm/url`][url] package for help building URLs. The
[`Url.absolute`][abs] and [`Url.relative`][rel] functions can be particularly
handy!

[url]: /packages/guida-lang/stdlib/latest/Url
[abs]: /packages/guida-lang/stdlib/latest/Url#absolute
[rel]: /packages/guida-lang/stdlib/latest/Url#relative

-}
load : String -> Cmd msg
load =
    Guida.Kernel.Browser.load
...
reload : Cmd msg
reload =
    Guida.Kernel.Browser.reload False
...
reloadAndSkipCache =
    Guida.Kernel.Browser.reload True
