...
[`Parser`](/packages/guida-lang/stdlib/latest/Parser) module, except that `String`
...
{-| This works just like [`Parser.run`](/packages/guida-lang/stdlib/latest/Parser#run).
...
consumeBase =
    Guida.Kernel.Parser.consumeBase


consumeBase16 : Int -> String -> ( Int, Int )
consumeBase16 =
    Guida.Kernel.Parser.consumeBase16
...
chompBase10 =
    Guida.Kernel.Parser.chompBase10
...
chompUntilEndOr str =
    Parser <|
        \s ->
            let
                ( newOffset, newRow, newCol ) =
                    Guida.Kernel.Parser.findSubString str s.offset s.row s.col s.src
...
isSubString =
    Guida.Kernel.Parser.isSubString
...
isAsciiCode =
    Guida.Kernel.Parser.isAsciiCode
...
findSubString =
    Guida.Kernel.Parser.findSubString
