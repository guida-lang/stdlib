...
decode (Decoder decoder) bs =
    Guida.Kernel.Bytes.decode decoder bs
...
signedInt8 =
    Decoder Guida.Kernel.Bytes.read_i8
...
signedInt16 endianness =
    Decoder (Guida.Kernel.Bytes.read_i16 (endianness == LE))
...
signedInt32 endianness =
    Decoder (Guida.Kernel.Bytes.read_i32 (endianness == LE))
...
unsignedInt8 =
    Decoder Guida.Kernel.Bytes.read_u8
...
unsignedInt16 endianness =
    Decoder (Guida.Kernel.Bytes.read_u16 (endianness == LE))
...
unsignedInt32 endianness =
    Decoder (Guida.Kernel.Bytes.read_u32 (endianness == LE))
...
float32 endianness =
    Decoder (Guida.Kernel.Bytes.read_f32 (endianness == LE))
...
float64 endianness =
    Decoder (Guida.Kernel.Bytes.read_f64 (endianness == LE))
...
bytes n =
    Decoder (Guida.Kernel.Bytes.read_bytes n)
...
string n =
    Decoder (Guida.Kernel.Bytes.read_string n)
...
fail : Decoder a
fail =
    Decoder Guida.Kernel.Bytes.decodeFailure
