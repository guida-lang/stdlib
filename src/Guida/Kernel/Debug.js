...
function _Debug_crash__DEBUG(identifier, fact1, fact2, fact3, fact4) {
	switch (identifier) {
		case 0:
			throw new Error('What node should I take over? In JavaScript I need something like:\n\n    Elm.Main.init({\n        node: document.getElementById("guida-node")\n    })\n\nYou need to do this with any Browser.sandbox or Browser.element program.');
		...
		case 5:
			throw new Error('Trying to use `(==)` on functions.\nThere is no way to know if functions are "the same" in the Elm sense.\nRead more about this at https://package.guida-lang.org/packages/guida-lang/stdlib/latest/Basics#== which describes why it is this way and what the better version will look like.');
		...
		case 10:
			throw new Error('Bug in https://github.com/guida-lang/stdlib/issues');
