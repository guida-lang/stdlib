 ...
 *  @param {Mesh} mesh The mesh coming in from Guida.
 *  @param {Object} attributes The mapping between the attribute names and Guida fields
 *  @return {WebGLBuffer}
 */
 ...
 *
 *  @param {WebGLRenderingContext} gl context
 *  @param {Mesh} mesh a mesh object from Guida
 ...
 *  @param {List<Option>} model.__options list of options coming from Guida
 *  @param {List<Entity>} model.__entities list of entities coming from Guida
