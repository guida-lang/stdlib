module Regex exposing
    ( Regex, fromString, fromStringWith, Options, never
    , contains, split, find, replace, Match
    , splitAtMost, findAtMost, replaceAtMost
    )
...
fromStringWith =
    Guida.Kernel.Regex.fromStringWith
...
split =
    Guida.Kernel.Regex.splitAtMost Guida.Kernel.Regex.infinity
...
find =
    Guida.Kernel.Regex.findAtMost Guida.Kernel.Regex.infinity
...
replace =
    Guida.Kernel.Regex.replaceAtMost Guida.Kernel.Regex.infinity
...
splitAtMost =
    Guida.Kernel.Regex.splitAtMost
...
replaceAtMost =
    Guida.Kernel.Regex.replaceAtMost
