...
{-| Guida has built-in syntax for tuples, so you can define 2D points like this:
...
info on this. (Picking appropriate data structures is super important in Guida!)
