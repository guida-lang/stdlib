...
{-| Low Level Guida Benchmarking API
...
on
`stdlib`](https://github.com/guida-lang/stdlib/issues/new)
...
operation fn =
    Guida.Kernel.Benchmark.operation fn
...
sample n operation_ =
    Guida.Kernel.Benchmark.sample n operation_
