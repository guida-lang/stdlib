...
{-| Passes if the
[`Result`](https://package.guida-lang.org/packages/guida-lang/stdlib/latest/Result) is
...
{-| Passes if the
[`Result`](http://package.guida-lang.org/packages/guida-lang/stdlib/latest/Result) is
