module Style.Font exposing
    ( typeface, font, serif, sansSerif, cursive, fantasy, monospace, importUrl
    , size, lineHeight, letterSpacing, wordSpacing, alignLeft, alignRight, center, justify, justifyAll
    , uppercase, capitalize, lowercase, underline, strike, italic, bold, weight, light
    )
