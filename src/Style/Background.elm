module Style.Background exposing
    ( image, coverImage, imageWith, repeatX, repeatY, repeat, space, stretch, noRepeat
    , natural, cover, contain, width, height, size
    , gradient, step, percent, px
    , gradientRight, gradientLeft, gradientUp, gradientDown, gradientTopRight, gradientBottomRight, gradientTopLeft, gradientBottomLeft
    )
