...
Every Guida project needs this package!
...
> **New to Guida?** Go to [guida-lang.org](https://guida-lang.org) for an overview.

## Default Imports

The modules in this package are so common, that some of them are imported by default in all Guida files. So it is as if every Guida file starts with these imports:
